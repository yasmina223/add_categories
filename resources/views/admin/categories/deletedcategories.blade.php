...
<div class="d-flex justify-content-between mb-3">
    ...
    <h3>Total Of Categories : {{count($trashedcategory)}} </h3>
</div>

<div class="row mt-3">
    <div class="col-md-8">
        <h3 class="text-center mb-3 text-dark"> All Trashed Categories</h3>
        ...
        @php($i=1)
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="{{route('category.forceDelete',$category->id)}}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            @endforeach
